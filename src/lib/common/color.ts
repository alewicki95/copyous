...
function getAngle(angle: string | undefined, unit: string | undefined): number {
...
function getPercent(number: string | undefined, percent: string | undefined, max: number): number {
	if (number === undefined) return 0;
	const n = Number(number);
	return percent ? (n / 100) * max : n;
}

function getAlpha(number: string | undefined, percent: string | undefined): number {
...
export class Color {
	...
	public static parseNamed(str: string): Color | null {
	...
	public static parseHex(str: string): Color | null {
	...
	public static parseRgb(str: string): Color | null {
	...
	public static parseHsl(str: string): Color | null {
	...
	public static parseHwb(str: string): Color | null {
	...
	public static parseLinearRgb(str: string): Color | null {
	...
	public static parseXyz(str: string): Color | null {
	...
	public static parseLab(str: string): Color | null {
	...
	public static parseLch(str: string): Color | null {
	...
	public static parseOkLab(str: string): Color | null {
	...
	public static parseOkLch(str: string): Color | null {
	...
	public toColor(space: ColorSpace): Color {
		switch (space) {
			case ColorSpace.Rgb:
				return this.rgb();
			case ColorSpace.Hex:
